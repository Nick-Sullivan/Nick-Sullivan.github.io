...
description: ""
published: true
image: ../../assets/images/gif_code06.gif
imageFit: contain
---
...
export const images = [
  ...
  { src: image08, alt: "Selecting a GIF.", height: 500 },
  { src: image09, alt: "The app showing the assembled GIF Code.", height: 500},
];
...
<ImageGallery
  images={[{ src: image00, alt: "Architectural diagram.", height: 300 }]}
/>
