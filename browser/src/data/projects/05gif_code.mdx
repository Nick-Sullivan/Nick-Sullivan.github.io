...
export const images = [
  { src: image01, alt: "QR Code on a celebration GIF.", height: 220 },
  { src: image06, alt: "QR Code on a pixelated dinosaur.", height: 220 },
  { src: image07, alt: "QR Code on a balloon popping.", height: 220 },
  { src: image10, alt: "QR Code on a man getting home from work.", height: 220 },
  { src: image11, alt: "QR Code on Homer Simpson sinking into a bush.", height: 220 },
  { src: image08, alt: "Selecting a GIF.", height: 500, className: "tall" },
  { src: image09, alt: "The app showing the assembled GIF Code.", height: 500, className: "tall" },
];
...
<ImageGallery
  images={[{ src: image00, alt: "Architectural diagram.", width: 848, height: 386 }]}
/>
